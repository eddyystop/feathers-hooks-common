...
var getByDot = function getByDot(obj, path) {
...
var setByDot = function setByDot(obj, path, value, ifDelete) {
...
myobj = { a: { b: undefined, x: 'x' }};
x = setByDot(myobj, 'a.b.c')
console.log('x=', myobj)

var obj = { a: { b: { c: 'abc' }}}
console.log('get a=', getByDot(obj, 'a'))
console.log('get a.b=', getByDot(obj, 'a.b'))
console.log('get a.b.c=', getByDot(obj, 'a.b.c'))
console.log('get a.x=', getByDot(obj, 'a.x'))

obj = { a: { b: { c: 'abc' }}, first: 'John'}
setByDot(obj, 'a', 'aa')
setByDot(obj, 'first', 'first')
console.log('set a=', obj)

obj = { a: { b: { c: 'abc' }}}
setByDot(obj, 'a.b', 'aa.bb')
console.log('set a.b=', obj)

obj = { a: { b: { c: 'abc' }}}
setByDot(obj, 'a.b.c', 'aa.bb.cc')
console.log('set a.b.c=', obj)

obj = { a: { b: { c: 'abc' }}}
setByDot(obj, 'a.b.c', undefined, true)
console.log('set a.b.c=undefined', obj)

obj = { a: { b: { c: 'abc' }}}
setByDot(obj, 'a.x', 'aa.xx')
console.log('set a.x=', obj)

obj = { a: { b: { c: 'abc' }}}
setByDot(obj, 'a.x.y', 'aa.xx.yy')
console.log('set a.x.y=', obj)
*/

var updateItems = function updateItems(hook, updater, condition) {
  ...
  if (items && condition) {
    if (hook.method === 'find' || Array.isArray(items)) {
      ...
      (items.data || items).forEach(updater);
    } else {
      updater(items);
    }
  }
...
function lowerCase() {
  ...
  return function (hook) {
    //const update = ifUpdate => updateItems(hook, lowerCaseFields, ifUpdate);
    var items = hook.type === 'before' ? hook.data : hook.result;
...
function remove() {
  ...
  return function (hook) {
    ...
    var update = function update(condition) {
      if (result && condition) {
        // todo Can updateItems be used here ? ****************************
