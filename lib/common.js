...
module.exports.validateUsingCallback = function (validator) {
  ...
  return function (hook, next) {
    ...
    function cb(formErrors, convertedValues) {
      if (formErrors) {
        throw new errors.BadRequest(formErrors instanceof Error ? formErrors : { errors: formErrors });
      }
...
module.exports.validateUsingPromise = function (validator) {
  ...
  return function (hook, next) {
    ...
    validator.apply(undefined, [utils.get(hook)].concat(rest)).then(function (convertedValues) {
      if (convertedValues) {
        utils.setAll(hook, convertedValues);
      }
